...
## [1.5.0](https://github.com/smaniches/alphafold-sovereign-mcp/compare/v1.4.7...v1.5.0) (2026-08-20)


### Features

* Configuration system + UniProt integration + enriched protein tool ([6dbc5c0](https://github.com/smaniches/alphafold-sovereign-mcp/commit/6dbc5c0cfda1da63ca4e5da424a49c2882e6689b))
...
* Initial release - AlphaFold Sovereign MCP Server ([90cfa82](https://github.com/smaniches/alphafold-sovereign-mcp/commit/90cfa8212d7c538f44e3946a29b870795d8f000d))
* Phase A+B - examples, CLI flags, registry manifests ([6b7c91e](https://github.com/smaniches/alphafold-sovereign-mcp/commit/6b7c91eb312b9df5505682ee9427789050ac1d29))
* Phase C - mkdocs-material docs site + gh-pages workflow ([cf2f537](https://github.com/smaniches/alphafold-sovereign-mcp/commit/cf2f53748cab9926297991ae610df18ae139b19a))
* Phase D - threat model, incident response, noxfile ([acc6e9f](https://github.com/smaniches/alphafold-sovereign-mcp/commit/acc6e9ff0ab29b917863225809de9201a01eae70))
* Phase E - benchmark, mutation testing, release + scorecard CI ([38e8749](https://github.com/smaniches/alphafold-sovereign-mcp/commit/38e8749cdcf0041560bfd83369d180da7b677f79))
* **phase1:** Add 9 enhanced AlphaFold analysis tools (16-&gt;25 tools) ([1bbacff](https://github.com/smaniches/alphafold-sovereign-mcp/commit/1bbacff4fa8ce3ad8c8a3545edb8153deb682737))
* **PR2:** Add 8 Protein Function Intelligence tools ([544faa6](https://github.com/smaniches/alphafold-sovereign-mcp/commit/544faa64733b5e3d99ba722d28625ecfb3f8cd01))
* **release:** publish to PyPI via OIDC Trusted Publishing ([8c5933d](https://github.com/smaniches/alphafold-sovereign-mcp/commit/8c5933d0df51df57613f13b5b6453ee54ad24a89))
* **release:** PyPI publishing via OIDC Trusted Publishing ([223812c](https://github.com/smaniches/alphafold-sovereign-mcp/commit/223812c567f681cebb69620b4011e8a715c8ea42))
...
* seed local KG + EFO disease-name fallback; release 1.2.0 ([#90](https://github.com/smaniches/alphafold-sovereign-mcp/issues/90)) ([3505c73](https://github.com/smaniches/alphafold-sovereign-mcp/commit/3505c73290d1a3bdf511bec02e61281d15f588d9))
* **test:** 17/20 modules at 100% line+branch coverage; archive monolith ([d81fe20](https://github.com/smaniches/alphafold-sovereign-mcp/commit/d81fe20f84f6391b5d782f6d18c8c7a080f0843d))
...
* Wave 0+1 — Apache 2.0 open-core, 14-source disease stack, precision medicine, TDA, local knowledge graph ([1f167e5](https://github.com/smaniches/alphafold-sovereign-mcp/commit/1f167e56eb809d8622f68d040128751de3efa31a))
* Wave 0+1 — Apache 2.0 open-core, 14-source disease stack, precision medicine, TDA, local knowledge graph ([99ba3d9](https://github.com/smaniches/alphafold-sovereign-mcp/commit/99ba3d990b29907ea4fd10ce1d31cf30cab1b7df))
...
* address 5 trust-critical issues from production review ([#41](https://github.com/smaniches/alphafold-sovereign-mcp/issues/41)) ([2b1e9cf](https://github.com/smaniches/alphafold-sovereign-mcp/commit/2b1e9cf5f8eee19738953d9f5ff33d486fbf6a79))
...
* **alphafold-client:** fetch /files/ resources at their advertised absolute URL ([cc8e64d](https://github.com/smaniches/alphafold-sovereign-mcp/commit/cc8e64dcf940cf1e06506c82ff1373c99dd0e296))
* **chembl:** restore drug retrieval broken by upstream schema drift ([6bd73eb](https://github.com/smaniches/alphafold-sovereign-mcp/commit/6bd73eba9b454a72d767dcb18d17eb0b4dd7fbcb))
...
* **ci:** consolidate Dependabot bumps + resolve Scorecard security alerts ([#42](https://github.com/smaniches/alphafold-sovereign-mcp/issues/42)) ([289758f](https://github.com/smaniches/alphafold-sovereign-mcp/commit/289758f5e4789205756cd0ab2dd2af96a3ae469b))
* **ci:** make package importable without deps + tighten coverage scope ([5458945](https://github.com/smaniches/alphafold-sovereign-mcp/commit/5458945adb8920ada2bb4d74d502d731159b1529))
* **ci:** replace uv pip install --system with uv sync --extra docs ([4da0c5d](https://github.com/smaniches/alphafold-sovereign-mcp/commit/4da0c5deb80366062838829dcac3e6d19d59d3c6))
* **ci:** skip CodeQL on private repos; tighten its scope to src/ ([7920dd1](https://github.com/smaniches/alphafold-sovereign-mcp/commit/7920dd16e2e75276fde02a6270e56df2d3faf78b))
* **ci:** verify wheel in isolated venv; commit uv.lock ([54b665b](https://github.com/smaniches/alphafold-sovereign-mcp/commit/54b665b87a2a0f936b23e8d94a51dffc7fcd24ee))
* **clients:** repair Open Targets + gnomAD data layer against current schemas ([6d79a43](https://github.com/smaniches/alphafold-sovereign-mcp/commit/6d79a431bc012c2697cc17ed63c8ce53dbd25e18))
...
* **clinvar:** resolve gene-relative HGVS to the correct variant ([abc71ec](https://github.com/smaniches/alphafold-sovereign-mcp/commit/abc71ecb7432489e4c15c70b849afef08ea03f99))
* **clinvar:** select the exact variant record; ship CI-diffed golden examples ([#160](https://github.com/smaniches/alphafold-sovereign-mcp/issues/160)) ([85c08fc](https://github.com/smaniches/alphafold-sovereign-mcp/commit/85c08fc72e33c874451fd1e5ad9609e2d9282b82))
* close lint-scope, version-drift, and coverage-gate gaps (audit pass) ([#49](https://github.com/smaniches/alphafold-sovereign-mcp/issues/49)) ([d8bc28d](https://github.com/smaniches/alphafold-sovereign-mcp/commit/d8bc28d53ad7bf0798161c8778321bc3dc796ef6))
...
* correct data-source count (14→9) and report product version in MCP handshake ([#50](https://github.com/smaniches/alphafold-sovereign-mcp/issues/50)) ([a8e3855](https://github.com/smaniches/alphafold-sovereign-mcp/commit/a8e3855194d999c221b0c310865f0eceba7610d6))
...
* Corrected method names in get_enriched_protein tool ([3cd7f33](https://github.com/smaniches/alphafold-sovereign-mcp/commit/3cd7f337eb766bc4b3276753265c76a54ea72176))
...
* Dynamic cache architecture - cache-first strategy + unified index ([52cbb78](https://github.com/smaniches/alphafold-sovereign-mcp/commit/52cbb78947ee2917aa240c765c15c9e69341f5df))
* **metadata:** resolve version drift, downgrade maturity, remove overclaims ([#48](https://github.com/smaniches/alphafold-sovereign-mcp/issues/48)) ([5330c5d](https://github.com/smaniches/alphafold-sovereign-mcp/commit/5330c5d9e38ec5dbd35f63322d2d55f4439edc4a))
* **opentargets:** normalise disease CURIEs so get_disease_targets returns results ([#52](https://github.com/smaniches/alphafold-sovereign-mcp/issues/52)) ([aefe1c1](https://github.com/smaniches/alphafold-sovereign-mcp/commit/aefe1c1c022b16e7e046ee513dec0edfd9a890ad))
* **pre-release:** address second-reviewer (Codex) findings before 1.2.0 tag ([#92](https://github.com/smaniches/alphafold-sovereign-mcp/issues/92)) ([56be31c](https://github.com/smaniches/alphafold-sovereign-mcp/commit/56be31c496dc723a14b148e9e6994786b22b1aee))
* **precision-medicine:** resolve AlphaMissense UniProt from the VEP consequence ([986ec6f](https://github.com/smaniches/alphafold-sovereign-mcp/commit/986ec6fceebdddc95d8ca7f29401d78b4649c216))
* **precision-medicine:** surface the MONDO disease label, not the CURIE ([ab7e1d9](https://github.com/smaniches/alphafold-sovereign-mcp/commit/ab7e1d90913495b3d74b019e509466bdf35c8604))
* redirect structlog to stderr and lazy-init async HTTP client ([c994fad](https://github.com/smaniches/alphafold-sovereign-mcp/commit/c994fad97ef75ac23200720b00b742a1520db6c0))
* **release:** align CITATION date with 1.4.6 ([42ab9f0](https://github.com/smaniches/alphafold-sovereign-mcp/commit/42ab9f08129ebc917ace21a8b8300d330004f040))
...
* **release:** cosign v3 emits one .sigstore bundle (no .sig/.crt) ([ff7b244](https://github.com/smaniches/alphafold-sovereign-mcp/commit/ff7b24447834b5e6a6ad355090e7f55264844eb7))
...
* **release:** make publish-github idempotent ([4d80d3e](https://github.com/smaniches/alphafold-sovereign-mcp/commit/4d80d3e1be9436fcf9334213ba3e94c452ab87b6))
* **release:** reference SLSA generator by tag, not SHA ([8a3a34d](https://github.com/smaniches/alphafold-sovereign-mcp/commit/8a3a34d844685a253977d8b0b75b727dca40552e))
* **release:** SBOM job - use uv venv instead of --system (PEP 668) ([f98abef](https://github.com/smaniches/alphafold-sovereign-mcp/commit/f98abef146e6891e3ac463a3a6091e309db19a18))
* **release:** un-SHA-pin the SLSA reusable workflow ref ([#39](https://github.com/smaniches/alphafold-sovereign-mcp/issues/39)) ([be866e9](https://github.com/smaniches/alphafold-sovereign-mcp/commit/be866e924b0e56654bda4c1d4ee7aa66a961beff))
...
* resolve all CI failures — tests, build, lint, review comments ([5a7d0a1](https://github.com/smaniches/alphafold-sovereign-mcp/commit/5a7d0a13500a2acc061d30a5c5017d35a7d8d223))
* resolve all mypy strict errors and ruff format violations ([627e4e2](https://github.com/smaniches/alphafold-sovereign-mcp/commit/627e4e292c4b9d2514224a83d2ee5a7aeb1ac893))
* resolve outstanding Gemini review feedback and complete the v6 audit ([ee35655](https://github.com/smaniches/alphafold-sovereign-mcp/commit/ee35655ad5213e3fe804509194af2a3b232f2c6b))
* **review:** part 1/2 - py3.10 compat + verify tolerance + tests ([da7cc76](https://github.com/smaniches/alphafold-sovereign-mcp/commit/da7cc7680a1ad514551d6bf8f168a3fd2d20b3f3))
* **review:** part 2/2 - raise coverage gate 60 -&gt; 99 ([b2c571f](https://github.com/smaniches/alphafold-sovereign-mcp/commit/b2c571f01a8d12c39fc1b3967fbbfa5d2c7a9e7d))
* **security:** address all 5 OpenSSF Scorecard alerts ([#43](https://github.com/smaniches/alphafold-sovereign-mcp/issues/43)) ([d092ad4](https://github.com/smaniches/alphafold-sovereign-mcp/commit/d092ad4a9250d38c1de2c12a6764f497c85a4678))
...
* **server:** serve all 29 tools from one shared FastMCP instance ([7592693](https://github.com/smaniches/alphafold-sovereign-mcp/commit/759269347632fa825815faab6536631a529e1717))
* source AlphaMissense scores from AlphaFold DB, not gnomAD ([08026a7](https://github.com/smaniches/alphafold-sovereign-mcp/commit/08026a78847c1a8608136d87741af158ae392d52))
...
* **structure-tools:** resolve AlphaFold file URLs from the prediction summary ([28857f1](https://github.com/smaniches/alphafold-sovereign-mcp/commit/28857f1af572494f3f0e0f8f8125c774c6be2e5d))
* **structure-tools:** route AlphaFold fetchers through AlphaFoldClient ([e009c94](https://github.com/smaniches/alphafold-sovereign-mcp/commit/e009c94c62f818094696e7e24e948103f9bdd484))
* **tests:** remove pytest_plugins from non-conftest test file ([20ac0b3](https://github.com/smaniches/alphafold-sovereign-mcp/commit/20ac0b309aebb35eccb2d815e3a823edad6edddd))
* **tools:** make map_disease_drug_landscape operative (MONDO→EFO) + verified example 03 ([#89](https://github.com/smaniches/alphafold-sovereign-mcp/issues/89)) ([6247602](https://github.com/smaniches/alphafold-sovereign-mcp/commit/62476025f93741d6583adb63a631c8a7931a0ea2))
* **tools:** restore three non-operative tools against live APIs ([#88](https://github.com/smaniches/alphafold-sovereign-mcp/issues/88)) ([478e909](https://github.com/smaniches/alphafold-sovereign-mcp/commit/478e90961e3c21824276282e0cd0ee4bb4b43226))
* **types:** add assert to narrow AsyncClient type after lazy init ([24d9971](https://github.com/smaniches/alphafold-sovereign-mcp/commit/24d99718faa7bfb4de81302fa77ca4bcad0f3294))

...
|---|---|---|
| Offline unit tests | Passing (740 tests) | `uv run pytest tests/` on every PR; CI matrix across Python 3.10–3.13 |
...
### Test suite
- **740 tests** (including parametrised expansions) across 20 modules.

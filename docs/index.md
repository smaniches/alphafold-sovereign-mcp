...
[![Tests](https://img.shields.io/badge/tests-613%20passing-success)](https://github.com/smaniches/alphafold-sovereign-mcp/actions/workflows/ci.yml)
...
> **v1.1.0-rc1 — release candidate.** Engineering-grade
> (613 tests, 99% branch coverage, full legal kit). Scientifically
